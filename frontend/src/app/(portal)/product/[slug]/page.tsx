...
export default function ProductDetailPage() {
  ...
  return (
    <main className="bg-white">
      {/* Breadcrumbs */}
      <div className="pt-32 pb-6 bg-slate-50 border-b border-slate-100">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="flex-1 space-y-6">
                <div className="aspect-square rounded-[40px] overflow-hidden bg-slate-50 border border-slate-100 shadow-inner group relative">
                    <img 
                    ...
                    <div className="absolute top-8 right-8 flex flex-col gap-3">
                        <button className="w-12 h-12 rounded-2xl bg-white/90 backdrop-blur-md shadow-xl flex items-center justify-center text-slate-400 hover:text-brand-accent-alt transition-all">
                            <Heart size={20} />
                        </button>
                        <button className="w-12 h-12 rounded-2xl bg-white/90 backdrop-blur-md shadow-xl flex items-center justify-center text-slate-400 hover:text-brand-primary transition-all">
                            <Share2 size={20} />
                        </button>
                    </div>
                </div>
            ...
            <div className="flex-1 space-y-10">
                <div>
                    ...
                    <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-[1.1] mb-6 uppercase">
                        {product.name}
                    </h1>
                ...
                <div className="flex flex-wrap gap-4 pt-6">
                    <button className="flex-1 min-w-[240px] bg-brand-primary text-white py-5 px-8 rounded-2xl font-black uppercase tracking-widest text-sm flex items-center justify-center gap-4 hover:bg-blue-800 transition-all shadow-xl shadow-brand-primary/20 group">
                        <Phone size={20} className="animate-icon-pulse fill-white" />
                        Liên hệ ngay
                    </button>
                    <button className="bg-brand-accent text-brand-primary py-5 px-10 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-brand-accent-hover transition-all shadow-xl shadow-brand-accent/20 flex items-center gap-3">
                        <Heart size={20} />
                        Yêu thích
                    </button>
                </div>
          ...
          <div className="container mx-auto px-4">
              <div className="max-w-4xl">
                  <div className="flex items-center gap-8 border-b border-slate-200 mb-10">
                      <button className="pb-4 text-sm font-black uppercase tracking-widest border-b-2 border-brand-primary text-brand-primary">Thông số kỹ thuật</button>
                      <button className="pb-4 text-sm font-black uppercase tracking-widest text-slate-400 hover:text-slate-600 transition-colors">Mô tả sản phẩm</button>
                      <button className="pb-4 text-sm font-black uppercase tracking-widest text-slate-400 hover:text-slate-600 transition-colors">Đánh giá (0)</button>
                  </div>
