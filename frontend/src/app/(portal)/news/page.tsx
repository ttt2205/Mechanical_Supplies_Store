...
export default function NewsPage() {
  return (
    <main>
      ...
      <section className="bg-[#020617] pt-40 pb-20 overflow-hidden relative border-b border-white/5">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <span className="text-xs font-black uppercase tracking-[0.3em] text-brand-accent drop-shadow-lg">Trung tâm thông tin</span>
              <span className="h-1 w-8 bg-brand-accent rounded-full shadow-[0_0_15px_rgba(245,158,11,0.6)]"></span>
          </div>
          ...
          <nav className="flex justify-center items-center gap-3 text-slate-400 text-xs font-black uppercase tracking-[0.2em]">
            <a href="/" className="hover:text-brand-accent transition-colors">Trang chủ</a>
