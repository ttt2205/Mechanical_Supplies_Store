...
export default function PartnersPage() {
  return (
    <main>
      {/* Hero Section */}
      <section className="bg-[#0f172a] pt-40 pb-24 overflow-hidden relative border-b border-white/5">
        {/* Background Glow */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-4 mb-8">
                ...
                <span className="text-xs font-black uppercase tracking-[0.4em] text-brand-accent drop-shadow-lg">Hệ sinh thái chiến lược</span>
                <span className="h-1 w-12 bg-brand-accent rounded-full shadow-[0_0_20px_rgba(245,158,11,0.6)]"></span>
            </div>
