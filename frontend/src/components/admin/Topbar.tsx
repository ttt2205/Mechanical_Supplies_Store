    ...
    return (
        <header className="h-20 bg-white border-b border-slate-100 flex items-center justify-between px-8 shrink-0 relative z-40">
            ...
            <div className="flex-1 max-w-xl">
                <div className="relative group">
                    ...
                    <input 
                        ...
                        className="w-full bg-slate-50 border-2 border-slate-50 rounded-2xl pl-12 pr-6 py-2.5 focus:bg-white focus:border-brand-primary outline-none transition-all text-sm font-bold text-slate-900 placeholder:text-slate-400"
                    />
                </div>
            </div>
            ...
            <div className="flex items-center gap-6">
                ...
                {/* Notifications */}
                <button className="relative p-2.5 bg-slate-50 text-slate-400 rounded-xl hover:bg-brand-primary/10 hover:text-brand-primary transition-all">
                    <Bell size={20} />
                ...
                <div className="relative">
                    ...
                    {isUserMenuOpen && (
                        <>
                            ...
                            <div className="absolute right-0 mt-4 w-64 bg-white rounded-[32px] shadow-[0_20px_70px_-10px_rgba(0,0,0,0.15)] border border-slate-100 overflow-hidden z-50 animate-reveal-scale">
